...
public class OthersCantLevelUpTest {
    ...
    public void setUp() throws Exception {
        ...
        strategyMove2 = new OthersCantLevelUp(match);
    }
    ...
    public void move() throws SantoriniException {
        ...
        strategyMove2.move(worker2_2, cellToMove2_2);
    ...
    public void move_moveSameLevel() throws SantoriniException {
        ...
        strategyMove1.move(worker1_1, cellToMove1_1_firstMove);
        ...
        strategyMove1.move(worker1_1, cellToMove1_1_secondMove);
    ...
    public void move_workerCanNotMove_throwsZeroCellsAvailableMoveException() throws SantoriniException {
        ...
        strategyMove2.move(worker2_1, cellToMove2_1);
    }
    ...
    @Test(expected = WrongCellSelectedMoveException.class)
    public void move_enemyWorkerWith_DefaultMove_WantsToLevelUpAfterAlliedWith_OthersCantLevelUp_GoneUp_throwsWrongCellSelectedMoveException() throws SantoriniException {

        // add a level in that cell
        match.getIsland().addComponent(Component.FIRST_LEVEL, match.getIsland().getCell(2, 1));

        // here we go from level 0 to level 1 with a worker with OthersCantLevelUp strategyMove
        Cell cellToMove2_2 = match.getIsland().getCell(2, 1);
        strategyMove2.move(worker2_2, cellToMove2_2);
        assertEquals(worker2_2, match.getLocation().getOccupant(cellToMove2_2));
        assertNull(match.getLocation().getOccupant(initCellWorker2_2));

        // here we try to go from level 0 to level 1 after an enemy with OthersCantLevelUp strategyMove level up
        Cell cellToMove1_1 = match.getIsland().getCell(1, 2);
        strategyMove1.move(worker1_1, cellToMove1_1);
    }

    @Test(expected = WrongCellSelectedMoveException.class)
    public void move_enemyWorkerWith_DoubleMove_WantsToLevelUpAfterAlliedWith_OthersCantLevelUp_GoneUp_throwsWrongCellSelectedMoveException() throws SantoriniException {

        strategyMove1 = new DoubleMove(match);
    ...
    @Test(expected = WrongCellSelectedMoveException.class)
    public void move_enemyWorkerWith_PushEnemyWorker_WantsToLevelUpAfterAlliedWith_OthersCantLevelUp_GoneUp_throwsWrongCellSelectedMoveException() throws SantoriniException {

        strategyMove1 = new PushEnemyWorker(match);
    ...
    @Test(expected = WrongCellSelectedMoveException.class)
    public void move_enemyWorkerWith_SwapWorker_WantsToLevelUpAfterAlliedWith_OthersCantLevelUp_GoneUp_throwsWrongCellSelectedMoveException() throws SantoriniException {

        strategyMove1 = new SwapWorker(match);
    ...
    public void thisIsNotATest_justPrintAvailableCells() {
        ...
        for (Player player : match.getPlayers()) {
            ...
            for (Worker worker : player.getWorkers()) {
                ...
                List<Cell> availableCells = strategyMove1.getAvailableCells(worker);
