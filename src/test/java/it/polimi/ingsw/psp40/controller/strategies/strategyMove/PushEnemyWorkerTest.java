...
public class PushEnemyWorkerTest {
    ...
    public void setUp() throws Exception {
        ...
        strategyMove = new PushEnemyWorker(match);
    }
    ...
    public void move_defaultMove() throws SantoriniException {
        ...
        Cell cellToMove2_2 = match.getIsland().getCell(2, 3);
    ...
    @Test
    public void move_pushEnemyWorker() throws SantoriniException {
        Cell cellToMove2_2 = initCellWorker1_2;
        strategyMove.move(worker2_2, cellToMove2_2);
        assertEquals(worker2_2, match.getLocation().getOccupant(cellToMove2_2));
        assertEquals(worker1_2, match.getLocation().getOccupant(match.getIsland().getCell(4, 4)));
        assertNull(match.getLocation().getOccupant(initCellWorker2_2));
    }

    @Test
    public void move_pushEnemyWorkerWithHighTowerBehind () throws SantoriniException {
        Cell cellToMove1_2 = initCellWorker2_2;
        strategyMove.move(worker1_2, cellToMove1_2);
        assertEquals(worker1_2, match.getLocation().getOccupant(cellToMove1_2));
        assertEquals(worker2_2, match.getLocation().getOccupant(match.getIsland().getCell(1, 1)));
        assertNull(match.getLocation().getOccupant(initCellWorker1_2));
    }

    @Test (expected = WrongCellSelectedMoveException.class)
    public void move_pushAlliedWorker_throwsWrongCellSelectedMoveException () throws SantoriniException {
        Cell cellToMove1_1 = initCellWorker1_2;
        strategyMove.move(worker1_1, cellToMove1_1);
    }
    ...
    public void move_workerWantsToGoTooFar_throwsWrongCellSelectedMoveException() throws SantoriniException {
        Cell cellToMove1_1 = match.getIsland().getCell(0, 4);
        strategyMove.move(worker1_1, cellToMove1_1);
    }
